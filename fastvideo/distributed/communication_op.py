...
def sequence_model_parallel_all_gather_async(input_: torch.Tensor, dim: int = -1) -> AsyncTensorHandle:
    """Start an inference-only all-gather across the sequence parallel group."""
